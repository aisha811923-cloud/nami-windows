...
const release = (over = {}) => ({
  ...
  draft: false,
  prerelease: false,
  html_url: 'https://github.com/aisha811923-cloud/nami-windows/releases/tag/v0.2.0',
  assets: [
...
test('falls back to the release page when no dmg matches', () => {
  ...
  assert.equal(r.url, 'https://github.com/aisha811923-cloud/nami-windows/releases/tag/v0.2.0');
});
